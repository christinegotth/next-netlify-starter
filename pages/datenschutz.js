    ...
    <div className="container">
      ...
      <main>
        ...
        <p>
          ...
          sobald Sie diese Website betreten. Wofür nutzen wir Ihre Daten? Ein
          Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der
          Website zu gewährleisten. Andere Daten können zur Analyse Ihres
          Nutzerverhaltens verwendet werden. 2/ 8 Welche Rechte haben Sie
          ...
          Berichtigung oder Löschung dieser Daten zu verlangen. Wenn Sie eine
          Einwilligung zur Datenverarbeitung erteilt haben, können Sie diese
          Einwilligung jederzeit für die Zukunft widerrufen. Außerdem haben Sie
          das Recht, unter bestimmten Umständen die Einschränkung der
          ...
          zu. Hierzu sowie zu weiteren Fragen zum Thema Datenschutz können Sie
          sich jederzeit an uns wenden. 2. Hosting Wir hosten die Inhalte
          unserer Website bei folgendem Anbieter: Externes Hosting Diese Website
          wird extern gehostet. Die personenbezogenen Daten, die auf dieser
          Website erfasst werden, werden auf den Servern des Hosters / der
          ...
          Bezug auf diese Daten befolgen. Wir setzen folgende(n) Hoster ein:
          ...
          Dritte ist nicht möglich. 3/ 8 Hinweis zur verantwortlichen Stelle Die
          verantwortliche Stelle für die Datenverarbeitung auf dieser Website
          ist: Christine Gotthardt Am Kohlenkämpchen 20 45133 Essen E-Mail:
          christinegotth [ @ ] posteo .de Verantwortliche Stelle ist die
          ...
          Datenschutzerklärung informiert. Widerruf Ihrer Einwilligung zur
          ...
          BESTIMMUNGEN GESTÜTZTES 4/ 8 PROFILING. DIE JEWEILIGE RECHTSGRUNDLAGE,
          ...
          technisch machbar ist. Auskunft, Löschung und Berichtigung Sie haben
          ...
          Daten 5/ 8 zu verlangen. Wenn Sie die Verarbeitung Ihrer
          ...
          Europäischen Union oder eines Mitgliedstaats verarbeitet werden. SSL-
          ...
          mitgelesen werden. 4. Datenerfassung auf dieser Website
          ...
          erfasst werden. Anfrage per E-Mail, Telefon oder Telefax Wenn Sie uns
          ...
          Ihres Anliegens). Zwingende gesetzliche Bestimmungen – 6/ 8
